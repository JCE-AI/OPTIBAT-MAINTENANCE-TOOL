...
def show_metrics_analysis(df_processed, available_flags):
    ...
    # Buscar FLAG_READY con TODAS las variantes conocidas (incluye ABG DALLA y espacios)
    ...
    # === DETECCIÓN DE COLUMNAS PARA ANÁLISIS AVANZADO ===
    # Reutilizar las mismas columnas detectadas anteriormente
