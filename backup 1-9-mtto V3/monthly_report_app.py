...
# =========================
"""
Sistema de mapeo de columnas para diferentes clientes.
Cada flag estándar (clave) puede tener múltiples variaciones (lista de valores).
El sistema detectará automáticamente qué variación usa cada cliente.
"""
FLAG_COLUMN_MAPPING = {
...
def show_metrics_analysis(df_processed, available_flags):
    ...
    if ready_col is None or on_col is None:
        ...
        st.warning(f"""
        ⚠️ **Columnas faltantes para análisis avanzado:**
