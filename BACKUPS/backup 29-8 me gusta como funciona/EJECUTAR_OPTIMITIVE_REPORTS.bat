...
echo.
echo URL de acceso: http://localhost:8502
echo Tambien disponible en: http://127.0.0.1:8502
echo.
...
cd /d "%~dp0"
streamlit run monthly_report_app.py --server.port=8502 --server.address=localhost
